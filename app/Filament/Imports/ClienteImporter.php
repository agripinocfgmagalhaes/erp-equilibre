...
class ClienteImporter extends Importer
{
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ImportColumn::make('conjuge_profissao')->rules(['nullable', 'max:100']),
            ImportColumn::make('conjuge_email')->rules(['nullable', 'email', 'max:100']),
            ImportColumn::make('conjuge_telefone')->rules(['nullable', 'max:20']),
