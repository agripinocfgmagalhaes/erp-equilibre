    ...
    protected static function getGridTableColumns(): array
    {
        return [
            Stack::make([
                ...
                TextColumn::make('projeto.nome')->sortable()->label('Projeto')->description('Empreendimento', position: 'above')->placeholder('—')->badge()->color(fn ($record) => $record->projeto->cor ?? $record->unidade->projeto->cor ?? 'gray'),
                Split::make([
