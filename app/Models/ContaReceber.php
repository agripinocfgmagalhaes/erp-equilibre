...
class ContaReceber extends Model
{
    ...
    protected $fillable = ['descricao','numero_documento','contrato_venda_id','cliente_id','plano_conta_id','conta_bancaria_id','projeto_id','valor','valor_recebido','data_vencimento','data_recebimento','status','observacoes','inter_codigo_solicitacao','inter_situacao','inter_emitido_em','inter_nosso_numero','inter_linha_digitavel','inter_pix_copia_cola'];
