...
class OrdenServico extends Model
{
    ...
    protected $fillable = ['numero','data','projeto_id','prestador_id','fase_obra_id','fase_padrao_id','descricao','valor_total','data_inicio','data_previsao_fim','data_conclusao','status'];
